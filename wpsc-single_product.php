...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">
                        ...
                        <fieldset class="prod_var_con"><legend><?php _e('Product Options', 'wpsc'); ?></legend>
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
                            	<fieldset class="prod_var_con"><legend><?php _e('Quantity', 'wpsc'); ?></legend>
						...
						<div class="like-container">
							<div class="twitter_like">
								<a href="https://twitter.com/share" class="twitter-share-button" data-via="ProjectMonMa" data-count="none">Tweet</a>
							</div>
							<div class="pinterest_pin">
		...
		<a href="http://projectmonma.org/products/checkout" class="btn"><i class="icon-shopping-cart"></i> View cart / Checkout</a><!--Added cart--> 
